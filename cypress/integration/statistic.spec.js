describe("Statistic", () => {
    ...
    it("display real-time track correctly", () => {
        cy.get(".ant-table-title").contains("实时统计");
    });
    it("check lines", () => {
        cy.get(
        ...
        response: {
            ...
            data: {
                logs: [
                    {
                        shortUrl: "1XK6lw",
                        long: "http://aogpi.bo/qouxprimk",
                        ip: "107.50.245.40",
                        source: "hklkv.sy",
                        time: "2020-07-20 15:14:42"
                    },
                    {
                        shortUrl: "NI3DW1",
                        long: "http://rxxytbk.lb/rgpeukz",
                        ip: "86.222.19.83",
                        source: "plev.kn",
                        time: "2020-07-20 15:14:42"
                    },
